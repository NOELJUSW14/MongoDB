...
router.get("/scrape", function(req, res) {
     axios.get("https://www.gocomics.com/comics/a-to-z").then(function(req,res) {
...
router.post("/comics/:id", function(req, res) {
  ...
  Comment.create(req.body)
    .then(function(dbComment) {
      ...
      return Comics.findOneAndUpdate({ _id: req.params.id }, { comments: dbComment._id }, { new: true });
    })
    .then(function(dbComment) {
